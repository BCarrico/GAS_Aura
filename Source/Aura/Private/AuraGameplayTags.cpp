...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Abilities_Arcane_ArcaneShards = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Abilities.Arcane.Shards"), FString("Arcane Shards Ability Tag"));
	// Passive Spells
