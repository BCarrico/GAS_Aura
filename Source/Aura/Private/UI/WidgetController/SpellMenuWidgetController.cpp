...
void USpellMenuWidgetController::SpellRowGlobePressed(const FGameplayTag& SlotTag, const FGameplayTag& AbilityType)
{
	...
	// Check selected ability against slots ability type. (don't equip offensive spell in a passive slot and vise versa).
	const FGameplayTag& SelectedAbilityType = AbilityInfo->FindAbilityInfoForTag(SelectedAbility.Ability).AbilityType;
...
void USpellMenuWidgetController::OnAbilityEquipped(const FGameplayTag& AbilityTag, const FGameplayTag& Status,const FGameplayTag& Slot, const FGameplayTag& PrevSlot)
{
	...
	// Broadcast empty info if PreviousSlot is a vlid slot. Only if equipping an already-equipped spell.
